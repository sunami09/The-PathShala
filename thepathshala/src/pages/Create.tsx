      ...
      {!roomCreated ? (
        <View style={style.content} onLayout={onLayout}>
          <View style={style.leftContent}>
            <Text style={style.subheading}>{"Presents"}</Text>
            <Text style={style.heading}>{"The PathShala"}</Text>
          ...
          <Text style={style.developed}>{"Developed By: Sunami Dasgupta \n Coordinated By: Dikshita Mehta, Ujjwal Singh, Divya Bhat"}</Text>
        </View>
      ) : (
        <Share
          urlView={urlView}
